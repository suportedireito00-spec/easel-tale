        ...
        >
          ...
          >
            ...
            <div className="flex-1 space-y-3 overflow-y-auto pr-1 text-left">
              <div>
                <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-accent-foreground/70">Explicação</p>
                <p className="text-[15px] leading-relaxed text-accent-foreground" style={{ fontFamily: "'Barlow', system-ui, sans-serif" }}>
                  {versoTexto}
                </p>
              </div>
              {exemploTexto && (
                <div className="rounded-xl border border-accent-foreground/20 bg-accent-foreground/10 p-3">
                  <p className="mb-1 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-accent-foreground/80">
                    <Lightbulb className="h-3.5 w-3.5" /> Exemplo prático
                  </p>
                  <p className="text-[14px] leading-relaxed text-accent-foreground" style={{ fontFamily: "'Barlow', system-ui, sans-serif" }}>
                    {exemploTexto}
                  </p>
                </div>
              )}
              {dicaTexto && (
                <div className="rounded-xl border border-accent-foreground/15 bg-accent-foreground/5 p-3">
                  <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-accent-foreground/70">Dica</p>
                  <p className="text-[14px] leading-relaxed text-accent-foreground/90" style={{ fontFamily: "'Barlow', system-ui, sans-serif" }}>
                    {dicaTexto}
                  </p>
                </div>
              )}
