      ...
      >
        ...
        <div className="relative px-4 pt-5 pb-5 min-h-[240px] flex flex-col gap-4">
          ...
          <div className="grid grid-cols-4 gap-2 mt-1">
            {[
              { label: 'Blog',       icon: ScrollText,  to: '/blog',       color: '#FBBF24', badgeColor: null, badgeKey: null, prefetch: 'blog' as PrefetchKey },
              { label: 'Biblioteca', icon: Library,    to: '/biblioteca', color: '#34D399', badgeColor: null, badgeKey: null, prefetch: 'biblioteca' as PrefetchKey },
              ...
              { label: 'Aprender',   icon: GraduationCap, to: '/aprender',  color: '#EFE039', badgeColor: null, badgeKey: null, prefetch: 'aprender' as PrefetchKey },
            ].map((item) => {
