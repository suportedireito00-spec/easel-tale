  ...
  if (isDesktop) {
    ...
    return (
      <motion.main
        ...
        className="min-h-dvh relative overflow-hidden bg-black flex items-center justify-center"
      >
        ...
        <div className="absolute inset-y-0 left-0 w-1/2 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute bottom-12 left-10 right-10 z-10 max-w-xl"
          >
            <div className="flex items-center gap-3 mb-5">
              <img
                src={logoOABnaRisca}
                alt="Vacatio"
                className="w-12 h-12 rounded-xl shadow-2xl object-cover border-2 border-primary/50"
              />
              <div className="h-px flex-1 bg-gradient-to-r from-primary/60 to-transparent" />
            </div>

            {/* Hierarquia principal */}
            <h1 className="font-display text-5xl xl:text-6xl font-black text-primary leading-[0.9] tracking-tight drop-shadow-2xl">
              VADE MECUM
            </h1>
            <h2 className="font-display text-xl xl:text-2xl font-semibold text-white/85 leading-tight mt-2 tracking-wide">
              Jurídico Profissional
            </h2>

            {/* Subheadline única, mais respiro */}
            <p className="mt-6 font-display text-lg xl:text-xl font-medium text-white/90 leading-snug max-w-md">
