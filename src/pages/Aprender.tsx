      ...
      <div className="mx-auto w-full max-w-3xl pb-32">
        ...
        >
          ...
          >
            ...
            {/* Camada de cor que iguala o amarelo da ilustração ao amarelo do hero,
                preservando a luminosidade do personagem (mix-blend-color só troca o matiz). */}
            <div
              className="absolute inset-0"
              style={{
                background: 'linear-gradient(135deg, #EFE039 0%, #F5EA5A 50%, #EFE039 100%)',
                mixBlendMode: 'color',
              }}
            />
            {/* Fade suave apenas na borda esquerda pra proteger o texto */}
            <div className="absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-[#EFE039] to-transparent" />
          </div>
