...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const tabelaCodigo: string = (body.tabelaNome || body.tabelaCodigo || '').toString().trim();
    const artigoNumero: string = (body.artigoNumero || '').toString().trim();
    ...
    const q = buildQuery(artigoNumero, leiNome);
